 ...
 *  Version 1.0
 *
 *    2020-04-09  Anatoli Arkhipenko
 *
 *      - deleted blink, added [] access to elemets
 *        more conservative size growth, no shrinking
 * 
...
class QueueArray {
  public:
    ...
    QueueArray (unsigned int init_size = 10);
...
// init the queue (constructor).
template<typename T>
QueueArray<T>::QueueArray (unsigned int init_size) {
